                        ...
                        <div class="module">
                            ...
                            <div class="module-body col-lg-12">
                                <table cellpadding="0" cellspacing="0" border="0"
                                    ...
                                    <tbody>
                                        <?php
                                        $qr_religions = mysqli_query($conn, "SELECT * FROM believers where parish_id='" . $_SESSION['id'] . "'");
                                        ...
                                        <tr>
                                            ...
                                            <td><?php
                                                    ...
                                                    $sel = mysqli_query($conn, "SELECT * FROM users WHERE ((user_id='" . $row["log_id"] . "')AND(user_type='believer'))");
                                                    while ($result = mysqli_fetch_array($sel)) {
                                                        echo $result["username"];
                                                        $l_id = $result["username"];
                                                    }
                                                    ?>
                                            ...
                                            <td><a class="btn btn-info btn-xs"
                                                    onclick="return confirm('Do you want to reset password with this loginID <?php print($l_id); ?> account')"
                                                    href="reset_user_pass?member_id=<?php echo $row[0]; ?>"> <i
