...
<?php 
    if(isset($_POST["submit"])){
        ...
        $check_exist = $conn->query("SELECT * FROM sacrament_issuing WHERE (((parish_id='".$_SESSION['id']."')AND(believer_id='$log_id')AND(issue='Eucharist')))");
        ...
        if(!mysqli_num_rows($check_church) > 0){
            ...
            if(empty($_POST["sys_id"])){
                ...
                if(mysqli_num_rows($check_exist) > 0){
                    echo "<script>alert('This person of this id ".basename($log_id)." is already have eucharist sacrament.');</script>";
                }else{
                    $query_system_ins = $conn->query("INSERT INTO sacrament_issuing(issue,parish_id,believer_id) VALUES('Eucharist','".$_SESSION['id']."','$log_id')");
                    if($query_system_ins){
...
<head>
    ...
    <head>
        ...
        <title>Register eucharist sacrament</title>
                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            <div class="module-head">
                                <h3>Add to eucharist sacrament</h3>
                            </div>
