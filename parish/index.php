<?php
	...
	if(isset($_POST["submit"])){
		...
		$query = mysqli_query($conn,"SELECT * FROM users WHERE (((username = '$username')AND(password= '$pass') AND (user_type='parish')))");
        ...
        $diocese_id = $conn->query("SELECT * FROM parishes WHERE id = '$id'");
        $dio_id_fetch = mysqli_fetch_array($relgion_id);
        $diocese_id = $rel_id_fetch["diocese_id"];
                ...
                <div class="module module-login span4 offset4">
                    <form class="form-vertical" method="POST">
                        <div class="module-head">
                            <h3>Login as Parish  <br> <small>(Christians parish )</small>
                            </h3>
                        </div>
