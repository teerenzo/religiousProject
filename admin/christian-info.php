                    ...
                    <div class="content">
                        ...
                        <div style="overflow-x: scroll;" class="module">
                            <div class="module-head">
                                <h3 style="text-transform:capitalize;">Christian <?php echo $names; ?></h3>
                            </div>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Parish</th>
                                            <th>Sucurisal</th>
                                            <th>Basic church (Umuryango remezo)</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            ?></td>
                                            <td><?php print($row["sucursal_name"]); ?></td>
                                            <td><?php print($row["basic_name"]); ?></td>
