<?php
    ...
    if (isset($_POST["submit"])){
        ...
        if(empty($name) || empty($email) || empty($phone)){
            ...
            $query = $conn->query("INSERT INTO sucursals(suc_name,email,phone,central_id,parish_id) VALUES('$name','$email','$phone','".$_SESSION['id']."','".$_SESSION['parish_id']."')");
           if($query){
            echo '<script>alert("Sucursal registration successful.");</script>';
                   echo "<script>window.location.href='add-sucursal';</script>";
           }else{
                            ...
                            <div class="module-body">
                                ...
                                <form method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" maxlength="10" name="phone" id="" required placeholder="Phone number"
                                            class="form-control span8">
                                    </div>
