                        ...
                        <div class="module">
                            ...
                            <div class="module-body col-lg-12">
                                <table cellpadding="0" cellspacing="0" border="0"
                                    ...
                                    <tbody>
                                        <?php
                                            $qr_religions = mysqli_query($conn,"SELECT * FROM sucursals where central_id='".$_SESSION['id']."'");
